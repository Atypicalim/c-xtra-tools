...
#define PNTR_IMPLEMENTATION_ONCE
    ...
    #ifndef PNTR_UTF8_PATH_H
    #define PNTR_UTF8_PATH_H "external/utf8.h"
    #endif
    #include PNTR_UTF8_PATH_H
...
PNTR_API pntr_font* pntr_load_font_default(void) {
        ...
        #ifndef PNTR_FONT_PATH_H
        #define PNTR_FONT_PATH_H "external/font8x8_basic.h"
        #endif
        #include PNTR_FONT_PATH_H
