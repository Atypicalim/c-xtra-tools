...
#define MYTIGR_EMIT(X, Y, Z) *text++ = X | ((cp >> Y) & Z)
    if (cp < 0x80) {
        MYTIGR_EMIT(0x00, 0, 0x7f);
    } else if (cp < 0x800) {
        MYTIGR_EMIT(0xc0, 6, 0x1f);
        MYTIGR_EMIT(0x80, 0, 0x3f);
    } else if (cp < 0x10000) {
        MYTIGR_EMIT(0xe0, 12, 0xf);
        MYTIGR_EMIT(0x80, 6, 0x3f);
        MYTIGR_EMIT(0x80, 0, 0x3f);
    } else {
        MYTIGR_EMIT(0xf0, 18, 0x7);
        MYTIGR_EMIT(0x80, 12, 0x3f);
        MYTIGR_EMIT(0x80, 6, 0x3f);
        MYTIGR_EMIT(0x80, 0, 0x3f);
    }
    return text;
